...
* LOOPS --> Has and belongs to many --> TRACKS
* LOOPS --> Has many --> KEYLOGS
* TRACKS --> Has and belongs to many --> LOOPS
* KEYLOGS --> Belong to --> LOOPS

== MUCH JAVASRIPT GOODNESS WILL BE HAD
